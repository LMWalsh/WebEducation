...
namespace WebEducation.Controllers
{
    ...
    {
        private readonly WebEducationContext _context; //variable initialized in ctor
        //no value upon declaring - once ctor is done it becomes a like a constant
        public MajorsController(WebEducationContext context) //ctor with var from above
        {
            _context = context;
        }
